...
# Logo
# st.sidebar.image('real-heart-icon-png-.png', width=150)
...
cho = st.sidebar.number_input("cholesterol (mmol/L)",0,20.00)
# Level of the rccach in the blood
rccach = st.sidebar.number_input("right carotid plaque height (cm)",0,10.00)
# Level of the max_ccach in the blood
max_ccach = st.sidebar.number_input("maximum double carotid plaque height (cm)",0,10.00)
# Level of the max_ccacl in the blood
max_ccacl = st.sidebar.number_input("maximum double carotid plaque length (cm)",0,10.00)
# Level of the ps in the blood
ps = st.sidebar.number_input("add double carotid plaque height (cm)",0,10.00)
...
if st.button("Predict"):
		...
		if prediction == 1:
			st.error("The patient hasn't a coronary heart disease")
		else:
			st.success("The patient has a coronary heart disease")
